package com.rahmat.card.config;
...
public class Config extends WebSecurityConfigurerAdapter{
	...
	public Docket api() throws IOException, XmlPullParserException {
		...
		return new Docket(DocumentationType.SWAGGER_2).pathMapping("/springfox/api/card")
				.securityContexts(Arrays.asList(securityContext())).securitySchemes(Arrays.asList(apiKey())).select()
				.apis(RequestHandlerSelectors.basePackage("com.rahmat.card.controller")).paths(PathSelectors.any())
				.build()
				.apiInfo(new ApiInfo("Card Api Documentation", "Documentation automatically generated",
						model.getParent().getVersion(), null, new Contact("Rahmat Yanuar",
